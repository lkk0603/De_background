...
%% De-background operation
Otus=reshape(R_frame,mmm*nnn,1);
aa=find(Otus==1);
Cell_sp1=Abs1(aa,:);
SE=strel('square',5);%Create convolution kernels to thicken cell walls to avoid misclassification of edge pixels
R_frame2=imdilate(R_frame,SE);
Otus2=reshape(R_frame2,mmm*nnn,1);
bb=find(Otus2==0);
Bg_sp1=Abs1(bb,:);
Bg_sp1_ave=mean(Bg_sp1,1);
% 561 reference 
b561=find(b==561);
cell561=Cell_sp1(:,b561);
bg561=Bg_sp1_ave(:,b561);
xs=cell561/bg561;
Cell_sp1_bgremoved=Cell_sp1-xs*Bg_sp1_ave;
